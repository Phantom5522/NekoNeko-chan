...
class NekoNekoChan(object):
    def __init__(self):
       ...
       # sensor values
        ...
        self.fsm.addState("backToCross").addFunc(self.drive.followLineSlow, 15, self.sensValues)
    ...
    def run(self):
        ...
        while True:
            ...
            # From any State
            if curState != "brake" and (self.sensValues["ColorLeft"][1] < 4.0 or self.sensValues["ColorRight"][1] < 4.0):
